...
def generate_story(data_analysis, df):
    ...
    request_payload = {
        ...
        "messages": [
            ...
            {
                "role": "user",
                "content": f"""Here are the key findings from data analysis:
                            {data_analysis}
                            Generate a concise, clear, and professional narrative story structured with clear insights, logical subheadings, and highlighting trends. 
